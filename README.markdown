...
- [tcladu](#tcladu)
    - [Demonstration](#demonstration)
        - [What did we just do?](#what-did-we-just-do)
            ...
            - [Populated the connected device database and queried the connected devices](#populated-the-connected-device-database-and-queried-the-connected-devices)
            - [Initialized device 0](#initialized-device-0)
            - [Sent the command to set/close the ADU100's relay](#sent-the-command-to-setclose-the-adu100s-relay)
            - [Queried the relay status](#queried-the-relay-status)
            - [Sent the command to reset/open the ADU100's relay](#sent-the-command-to-resetopen-the-adu100s-relay)
            - [Queried the relay status again](#queried-the-relay-status-again)
